...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Ingredientes arrayIngredientes[] = new Ingredientes[3];
        arrayIngredientes[0] = new Ingredientes();
        arrayIngredientes[1] = new Ingredientes("jamón",200);
        arrayIngredientes[2] = new Ingredientes();

        System.out.println("Muy buenas, tenemos estas pizzas disponibles: ");
        p.mostrarTamagnosPizza();
    }
}
